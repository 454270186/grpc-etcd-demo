...
type HelloServiceClient interface {
	GetHello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRes, error)
}
...
func (c *helloServiceClient) GetHello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRes, error) {
	out := new(HelloRes)
...
type HelloServiceServer interface {
	GetHello(context.Context, *HelloReq) (*HelloRes, error)
...
func (UnimplementedHelloServiceServer) GetHello(context.Context, *HelloReq) (*HelloRes, error) {
...
func _HelloService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).GetHello(ctx, req.(*HelloReq))
	}
